...
const SundayDiscourse: React.FC<SundayDiscourseProps> = ({ settings, setGlobalLoadingMessage }) => {
  ...
  return (
    <div className="p-4 border border-gray-200 rounded-lg shadow-sm text-[var(--text-color)]">
      <h3 className="text-xl font-semibold mb-4">Discours de Dimanche</h3>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center mb-3">
          ...
          />
          <label htmlFor="generateThemeSunday" className="text-base">Laisser l'IA générer le thème</label>
        </div>
        {!generateTheme && (
          <input
            type="text"
      ...
      >
        Générer le Discours de Dimanche
      </button>
    </div>
  );
};
