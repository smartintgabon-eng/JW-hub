...
const ThursdayDiscourse: React.FC<ThursdayDiscourseProps> = ({ settings, setGlobalLoadingMessage, onGenerated }) => {
  ...
  const renderStepIndicator = () => (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-xl font-black uppercase tracking-tight text-[var(--btn-color)]">Discours de Jeudi</h3>
      ...
      <div className="bg-white/5 border border-white/10 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden">
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            >
              <span>Générer le Discours de Jeudi</span>
            </button>
          </div>
        )}
      </div>
