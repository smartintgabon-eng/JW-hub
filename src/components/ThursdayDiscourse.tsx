...
const ThursdayDiscourse: React.FC<ThursdayDiscourseProps> = ({ settings, setGlobalLoadingMessage }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert(`Discours de Jeudi généré avec le thème : ${finalTheme} (Placeholder)`);
    } catch (error) {
  ...
  return (
    <div className="p-4 border border-gray-200 rounded-lg shadow-sm text-[var(--text-color)]">
      <h3 className="text-xl font-semibold mb-4">Discours de Jeudi</h3>
